function [signal_x, signal_y, Excited_x, Drive_x, Drive_y] = calculate_signal(DC_ratio, Phantom,Excited_Amp, Excited_fre, Drive_Amp, Drive_x_fre, Drive_y_fre,Gradient_x, sample_rate, particle_diameters, X, Y)
...
%% 激励场设置
s_e = 0.6;       % 激励线圈灵敏度待确认
Excited_x = s_e * (Excited_Amp * sin(2 * pi * Excited_fre * time_discrete) + DC_ratio*Excited_Amp);
%% 驱动场参数设置
s_x = 0.87;    % [mT/A]   线圈灵敏度 仿真非必要参数
s_y = 1.74;     % [mT/A]
A_x = Drive_Amp;       % [A]
A_y = Drive_Amp;       % [A]
